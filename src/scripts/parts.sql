...
CREATE TABLE if not exists inputs_0 PARTITION OF inputs FOR VALUES WITH (MODULUS 8,REMAINDER 0) using columnar;
CREATE TABLE if not exists inputs_1 PARTITION OF inputs FOR VALUES WITH (MODULUS 8,REMAINDER 1) using columnar;
CREATE TABLE if not exists inputs_2 PARTITION OF inputs FOR VALUES WITH (MODULUS 8,REMAINDER 2)  using columnar;
CREATE TABLE if not exists inputs_3 PARTITION OF inputs FOR VALUES WITH (MODULUS 8,REMAINDER 3)  using columnar;
CREATE TABLE if not exists inputs_4 PARTITION OF inputs FOR VALUES WITH (MODULUS 8,REMAINDER 4)  using columnar;
CREATE TABLE if not exists inputs_5 PARTITION OF inputs FOR VALUES WITH (MODULUS 8,REMAINDER 5)  using columnar;
